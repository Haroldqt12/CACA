...
<body>
    ...
    <h1>SUV</h1>
        <div class="container">
            <img class="set1images"src="../VEHICLE_CAT/CAR_IMG/capture15.jpg">
               <div class="paragraph"><p>Make: Mazda<br>
                                            Model: Mazda3 hatchback <br>
                                            Year: 2023<br>
                                            Color: Blue<br>
                                            Engine Type: SKYACTIV-G 2.0L<br>
                                            Transmission: SKYACTIV-Drive 6-Speed Automatic with Sport Mode<br>
