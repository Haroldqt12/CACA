...
<div class="topnav">
    ...
    <h1>Honda civic</h1>
        <div class="container">
            <img class="set1images" src="../VEHICLE_CAT/CAR_IMG/capture1.jpg">
            <div class="paragraph"><p>Make: BMW<br>
                                            Model: BMW 3 Series<br>
                                            Year: 2023<br>
                                            Color: Black<br>
                                            Engine Type: TwinPower Turbo4-cylinder petrol engine<br>
                                            Transmission: 8-speed Steptronic Sport<br>
