...
<div class="topnav">
    ...
    <h1>Honda civic</h1>
        <div class="container">
            <img class="set1images"src="../VEHICLE_CAT/CAR_IMG/capture3.jpg">
            <div class="paragraph"><p>Make: Mitshubishi<br>
                                            Model: Lancer Evo<br>
                                            Year: 2015<br>
                                            Color: Red<br>
                                            Engine Type:  two-litre intercooled turbo inline four-cylinder engines<br>
                                            Transmission: 6-speed TC-SST<br>
