...
<body>
                ...
                <li>
                    <a href="#" id="profile">
                        ...
                        <ul class="drop_profile">
                            ...
                            <li><a id="dropdown4" href="../DATABASE/6logout.php">Log Out</a></li>
                        </ul>
                </li>
            </ul> 
        </div>
    <h1>SUV</h1>
        <div class="container">
            <img class="set1images"src="../VEHICLE_CAT/CAR_IMG/capture10.jpg">
               <div class="paragraph"><p>Make: Hyundai <br>
                                            Model: Tucson SE <br>
                                            Year: 2016<br>
                                            Color: White<br>
                                            Engine Type: 4 Cylinder Engine Regular Unleaded I-4<br>
