...
<body>
    ...
    <h1>SUV</h1>
        <div class="container">
            <img class="set1images"src="../VEHICLE_CAT/CAR_IMG/capture19.jpg">
               <div class="paragraph"><p>Make: Volkswagen <br>
                                            Model: GOLF GTI<br>
                                            Year: 2022<br>
                                            Color: Lime Green<br>
                                            Engine Type: 1.5L Turbocharged<br>
                                            Transmission: 6-speed manual or 7-speed automatic DSG®<br>
